            ...
            <main className={styles.main}>
                ...
                <div className={styles.interactionArea}>
                    ...
                    >
                        {" "}
                        <img
                            className={styles.imgToLeft}
                            src="https://img.icons8.com/ios-filled/100/000000/chevron-left.png"
                        />{" "}
                    </div>
                    <div
                    ...
                    >
                        <img
                            className={styles.imgToRight}
                            src="https://img.icons8.com/ios-filled/100/000000/chevron-right.png"
                        />
                    </div>
                </div>
